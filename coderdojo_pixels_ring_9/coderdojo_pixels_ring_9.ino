...
// Hoofdlus
void loop() {
  // Zoals we voordien gezien hebben kunnen we met kleurAllePixels() alle pixels dezelfde kleur geven.
  ...
  // Opdracht:
  // We willen nu een een functie die enkel de eerste pixel kleurt, daarna enkel de tweede, enzovoort.
  // Tot en met de laatste pixel. Tussen elke stap wacht je een 100 milliseconde.
  // Vul 'void draaiendePixel(uint32_t kleur) {}' verder aan
  // Kijk eerst eens naar 'void kleurAllePixels(uint32_t kleur) {}' om je op weg te helpen.
