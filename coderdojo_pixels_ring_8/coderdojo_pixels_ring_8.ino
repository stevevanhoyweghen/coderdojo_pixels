...
// Hoofdlus
void loop() {
  kleurAllePixels(pixels.Color(random(255), random(255), random(255)));
  delay(100);

  /*
  We weten nu veel over kleuren.
  Laat ons nu nog wat leuke effecten maken.
  Open de negende oefening.
  */
}
