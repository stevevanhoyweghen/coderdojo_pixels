...
void loop() {
  ...
  pixels.show();
  delay(100);
  draaiendePixel(KLEUR_BLAUW, 100);
  draaiendePixel2(KLEUR_BLAUW, 100);

  /*
  Opdracht:

  Maak met alles wat je geleerd hebt een leuke lichtshow!
  Als je wil kan je zelf nog andere functies met effecten toevoegen.
  */
}
